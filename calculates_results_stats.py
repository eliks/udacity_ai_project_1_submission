...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic.items():
        if results_dic[key[0]][2] == 1:
            results_stats_dic['n_match'] += 1
        if results_dic[key[0]][3] == 1:
            results_stats_dic['n_dogs_img'] += 1

            if results_dic[key[0]][4] == 1:
    ...
    if results_stats_dic['n_images'] == 0:
        ...
        results_stats_dic['pct_correct_dogs'] = 100.0 * results_stats_dic['n_correct_dogs'] / results_stats_dic['n_images']
        results_stats_dic['pct_correct_breed'] = 100.0 * results_stats_dic['n_correct_breed'] / results_stats_dic['n_images']
